    ...
    <div className="w-full max-w-7xl mx-auto py-4">
      ...
      <section className="space-x-2 space-y-2 py-2">
        ...
        <div className="flex md:flex-row flex-col gap-2 w-full">
          {/* Left Side */}
          <div className="flex flex-col w-full max-w-full md:max-w-lg gap-2">
            <div className="w-full h-[125px] bg-primary">Cuaca Hari ini</div>
            <div className="w-full h-[300px] bg-primary">
              Prakiraan Cuaca selama 3 hari
            </div>
            <div className="w-full h-[125px] bg-primary">
              Kabar Gempa bumi terbaru
            </div>
          </div>
          {/* Right Side */}
          <div className="flex flex-col w-full max-w-full gap-2">
            <div className="w-full h-full bg-primary">Map</div>
            <div className="w-full h-full bg-primary">AI Analysis</div>
          </div>
        </div>
        {/* Bottoms */}
        <div className="flex md:flex-row flex-col gap-2 w-full">
          <div className="h-[150px] w-full md:max-w-[50%] max-w-full bg-primary">
